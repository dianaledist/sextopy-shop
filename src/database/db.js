...
var productosDB = [
  ...
  { 
      ...
      url: productjugt1, 
      descripcion:'Estimulador y succionador de clítoris para orgasmos más intensos. ', 
  ...
  { 
      id: 10, 
      categoria: 'juguetes-y-etc',
      nombre: 'Lubricante estimulante', 
      url: productjugt4, 
      descripcion:'Lubricante estimulante efecto calor.', 
      cttas: 'Lubricante a base de agua con efecto de calor, ideal para implementar la sensación de placer',
      precio: 18, 
      stock:20,
      quantity:0,
      destacado: false
